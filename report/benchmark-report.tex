...
outperforms hmatrix (OpenBLAS/LAPACK) in eight of nine categories
at $200{\times}200$ and all nine at $500{\times}500$.  The one remaining
gap---SVD at $100{\times}100$ ($1.86\times$, inherent to the $A^\top A$
eigendecomposition approach)---and the potential to deepen existing
advantages define the roadmap below.  Round~19 closed the eigenSH gap
entirely (parity at~100, $0.69\times$ at~200) and brought SVD to parity
at~200.
