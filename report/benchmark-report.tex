...
categories of numerical operations through six rounds of optimisation.
...
($3\text{--}6\times$), attributable to the explicit $A^T A$ formation
rather than direct bidiagonalisation.
