...
categories of numerical operations through eleven rounds of optimisation.
...
decomposition sits near parity ($1.02\text{--}1.17\times$ up to
$100{\times}100$, rising to $1.38\times$ at $500{\times}500$), while
SVD ($1.5\text{--}2.7\times$) remains the sole significant bottleneck,
driven primarily by the eigendecomposition sub-step and requiring
blocked Householder bidiagonalisation to close.
