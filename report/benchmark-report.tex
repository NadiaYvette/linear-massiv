...
on top of an eigensolve that is merely at parity with hmatrix/LAPACK.  The
...
already $1.5\text{--}2.1\times$ faster than hmatrix/LAPACK.
...
the sole remaining category where \texttt{linear-massiv} trails hmatrix/LAPACK.
...
is faster than hmatrix/LAPACK, with SVD now $1.3\times$ faster ($0.76\times$).
