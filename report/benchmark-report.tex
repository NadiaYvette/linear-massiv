...
Algorithm~8.6.2 more closely.  This fix only affects \texttt{svdGKP}
...
categories of numerical operations through thirteen rounds of optimisation.
...
seven}: GEMM (single-threaded and parallel), dot product, matrix--vector
multiply, LU solve, Cholesky solve, and QR factorisation.  Eigenvalue
decomposition sits near parity ($0.92\text{--}1.12\times$ up to
$100{\times}100$, rising to $1.30\times$ at $500{\times}500$), while
SVD ($1.9\text{--}3.1\times$) remains the sole significant bottleneck,
driven primarily by the eigendecomposition sub-step.  A panel-factorisation
tridiagonalisation or divide-and-conquer bidiagonal SVD are the most
promising paths to closing this gap.
